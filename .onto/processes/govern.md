...
본 v0 는 **현 product 내부 규범** (authority/, .onto/processes/, .onto/commands/, .onto/principles/, .onto/roles/ 등) 의 변경 관리에만 적용한다. 다음은 범위 밖:
...
| 본문 배치 | `.onto/principles/*.md` + `.onto/processes/*.md` | `authority/core-lexicon.yaml` 내부 |

...
| 원칙 | canonical 위치 |
|---|---|
| Ownership Rule (LLM/runtime 소유 분리) | `design-principles/llm-native-development-guideline.md` |
| Interface Rule (artifact-first, boundary seat) | `design-principles/llm-runtime-interface-principles.md` |
| Replace one boundary at a time | `design-principles/productization-charter.md` §7 Development Method |
| Always Keep Working | `design-principles/productization-charter.md` §8 Always-Keep-Working Rule |
| Fail-Close Rule | `design-principles/llm-native-development-guideline.md` (테스트 전략 §3 production review) |
| TypeScript Core Rule | `design-principles/productization-charter.md` §4.1 core는 TypeScript로 구현한다 |

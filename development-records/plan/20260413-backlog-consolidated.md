...
| BL-041 | BL-4 Authority/Lineage Compatibility Gate (axiology proposal, 여러 리뷰 반복) | G | D | already covered | supporting | DR-M03-01 resolved (disposition_basis). DR-M03-02 경로 (d) 적용. Schema 반영: DL-006 dedup_evidence_schema `kept_primary_source`/`linked_supporting_sources`. 양방향 링크: DL-006 resolution_note |

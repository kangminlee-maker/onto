...
| `learning promote` 결과 | learning 이 project → user scope 이동 (글로벌 소비 가능) | `processes/promote.md` |
...
- **design-principles/ 파일들의 authoring path 가 미정의**
  - `learning.execution_rules_ref = "processes/promote.md"` (명시)
  - `domain_document.execution_rules_ref = "processes/promote-domain.md"` (명시)
...
- `learning.execution_rules_ref = "processes/promote.md"` (learning 전이 명시)
- `domain_document.execution_rules_ref = "processes/promote-domain.md"` (domain 전이 명시)
...
| `processes/promote.md` | authoring path 섹션 명시 + learning_scope_promotion 용어 명시 |

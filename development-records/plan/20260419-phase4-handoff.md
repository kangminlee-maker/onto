...
- **보강 (2026-04-22, Stage 2 Step 4 §0.1)**: dogfood 는 SDK-like layer — off 가능 + 들어내기 쉬워야 함. 5 활동 본질 sink 는 dogfood 와 독립 (의존 방향: 본질 sink ← dogfood reader). 본 Log seat 는 dogfood layer 의 mirror/aggregation 위치이며, 5 활동의 본질 산출물은 각 활동 namespace 내부에 별도 기록. Mandatory 는 Phase 4 dogfood 단계 한정 운영 정책으로 재해석. 정본 규약: `.onto/processes/govern.md §14.6`

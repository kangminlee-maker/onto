...
// ---------------------------------------------------------------------------
export const META_NAME_REGISTRY = ["help", "version"];
export const CURRENT_CATALOG_VERSION = 1;
export const CATALOG_VERSION_HISTORY = {
    1: {
        introduced_in: "0.3.0",
        description: "Initial catalog with three entry kinds (PublicEntry + RuntimeScriptEntry + MetaEntry).",
        breaking_changes: [],
    },
};
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
const CLI_HANDLER = { handler_module: "src/cli.ts" };
export const COMMAND_CATALOG = {
    ...
    entries: [
        ...
        // ───────────────────────────────────────────────────────────────────────
        {
            ...
            description: "Show installation mode, onto home, project root, and runtime info.",

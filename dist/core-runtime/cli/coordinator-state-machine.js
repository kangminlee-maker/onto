    ...
    switch (currentState) {
        case "awaiting_lens_dispatch": {
            try {
                ...
                applyTransition(stateFile, "validating_lenses", "awaiting_synthesize_dispatch");
                await writeStateFile(sessionRoot, stateFile);
                return {
        ...
        case "awaiting_synthesize_dispatch": {
            ...
            try {
                ...
                if (synthesisDeliberationStatus === "required_but_unperformed") {
                    throw new Error("completing step 2: synthesis output declares " +
        ...
        case "awaiting_adjudication": {
            throw new Error("Adjudication dispatch is not yet implemented. Build-mode pipeline extension (W-B-05).");
        }
        case "awaiting_deliberation": {
            ...
            throw new Error("awaiting_deliberation is unreachable under the canonical review " +

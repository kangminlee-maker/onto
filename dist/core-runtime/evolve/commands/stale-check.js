...
import { computeDirectoryHash, walkDirectory, normalizePath } from "../../readers/file-utils.js";
 ...
 */
export function checkStale(paths) {
    ...
    const recordedHashes = groundingCompleted.payload.source_hashes;
    ...
    for (const source of sources) {
        ...
        if (!oldHash)
            continue; // Source wasn't in last grounding
 ...
 */
export function checkAndRecordStale(paths) {
...
// ─── Helpers ───
function computeCurrentHash(source) {

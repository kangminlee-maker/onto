...
import { genericMcpSourceHashKey, genericMcpSourceHash, scanGenericMcp, recordGenericMcpGrounding, } from "./mcp-generic.js";
...
describe("genericMcpSourceHash", () => {
    ...
    it("key matches genericMcpSourceHashKey output", () => {
        ...
        expect(genericMcpSourceHash(source, "digest").key).toBe(genericMcpSourceHashKey(source));
    });
});

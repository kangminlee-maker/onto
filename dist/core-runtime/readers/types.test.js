...
import { sourceKey, toGroundingSource, isScanError, isScanSkipped } from "./types.js";
describe("sourceKey", () => {
    it("add-dir", () => {
...
describe("isScanSkipped", () => {
    const source = { type: "github-tarball", url: "https://github.com/a/b" };
    it("returns true for ScanSkipped", () => {
        const skipped = { skipped: true, source, cached_hash: "abc123" };
    ...
    it("returns false for ScanError", () => {
        const err = { source, error_type: "network", message: "fail" };
...
describe("isScanError", () => {
    ...
    it("returns false for ScanSkipped", () => {
        const skipped = { skipped: true, source, cached_hash: "abc" };

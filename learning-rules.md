...
**Learning의 핵심 가치**: `authority/core-lexicon.yaml` entities.learning 참조. 소비(consumption)는 promoted 학습만 대상 — `design-principles/project-locality-principle.md` §2.2 참조.

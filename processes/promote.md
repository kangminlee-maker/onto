...
프로젝트 수준 학습(`{project}/.onto-review/learnings/`)을 검수하여 글로벌 수준(`~/.onto-review/learnings/`)으로 승격합니다. 축 태그를 보존하며, 승격 시 태그 적절성도 검수합니다.
...
- 글로벌 학습: `~/.onto-review/learnings/{agent-id}.md`의 기존 항목
...
- **신규 승격**: 항목을 `~/.onto-review/learnings/{agent-id}.md` 끝에 추가합니다 (축 태그 포함).
...
글로벌 학습 경로: `~/.onto-review/learnings/`
```

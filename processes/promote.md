...
프로젝트 수준 도메인 학습(`{project}/.onto-review/learnings/`)을 검수하여 글로벌 수준(`~/.onto-review/domains/{domain}/learnings/`)으로 승격합니다.
...
- 글로벌 학습: `~/.onto-review/domains/{domain}/learnings/{agent-id}.md`의 기존 항목
...
- **신규 승격**: 항목을 `~/.onto-review/domains/{domain}/learnings/{agent-id}.md` 끝에 추가합니다.
...
사용자 승인 시:
- 문서가 없으면 `~/.onto-review/domains/{domain}/concepts.md` 또는 `competency_qs.md`를 생성합니다.
...
글로벌 학습 경로: `~/.onto-review/domains/{domain}/learnings/`
```

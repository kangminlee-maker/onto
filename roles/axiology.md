...
이 관점은 가치/목적 정렬에만 초점을 둔다. 다른 모든 lens finding을 집계하여 최종 결과를 만드는 것은 synthesize의 역할이고, 형식 논리적 모순·구조적/의존성 결함의 1차 탐지는 별도 관점의 범위이다. axiology는 그러한 결함이 가치·목적에 미치는 영향을 평가한다.

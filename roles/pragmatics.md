# pragmatics (pragmatic fitness verification agent)
...
- **Boundary -- NOT responsible for**:
  - The existence of unnecessary elements per se -> handled by conciseness
  - Missing domain areas -> handled by coverage
- **Domain examples**:

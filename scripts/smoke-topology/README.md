...
로 token 최소화. 그럼에도 실행 당 codex / Claude 호출 N+1 회 (lens N + synthesize 1) 발생.
모든 topology 를 한 번씩 돌리면 7 회 review × 10~12 unit ≈ 80 호출.
구독 내 소비 수준이지만 빈번히 돌리지는 않는 것이 원칙.

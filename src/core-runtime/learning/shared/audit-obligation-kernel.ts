...
export type AuditObligationStatus =
  | "pending"
  | "in_progress"
  | "blocked"
  | "fulfilled"
...
export type AuditTriggerKind =
  ...
  | "retirement_threshold_exceeded"
  | "degraded_state_threshold_exceeded";

export interface StatusTransition {
  from: AuditObligationStatus | null;
...
export const LEGAL_TRANSITIONS: Readonly<
  Record<AuditObligationStatus, readonly AuditObligationStatus[]>
> = {
 ...
 */
export const TERMINAL_STATUSES: ReadonlySet<AuditObligationStatus> = new Set([
  "fulfilled",
  "no_eligible_agents",
  "waived",
]);

export function isTerminalStatus(status: AuditObligationStatus): boolean {

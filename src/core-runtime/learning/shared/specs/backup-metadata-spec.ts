...
import type { BackupMetadata } from "../../promote/types.js";
import {
  parseRaw,
  serializeRaw,
  rejectPreV7,
...
export const BackupMetadataSpec: ArtifactSpec<BackupMetadata> = {
  kind: KIND,
  ...
  parse(content, format) {
    ...
    return rejectPreV7<BackupMetadata>(raw, KIND, SUPPORTED);
  },

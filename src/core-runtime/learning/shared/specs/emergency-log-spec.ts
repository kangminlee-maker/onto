...
import type { EmergencyLogEntry } from "../../promote/types.js";
import {
  rejectPreV7,
  checkSchemaVersion,
  checkString,
...
export const EmergencyLogSpec: ArtifactSpec<EmergencyLogEntry> = {
  kind: KIND,
  ...
  parse(content, _format) {
    ...
    return rejectPreV7<EmergencyLogEntry>(raw, KIND, SUPPORTED);
  },

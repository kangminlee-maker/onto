...
import type { RestoreManifest } from "../../promote/types.js";
import {
  parseRaw,
  serializeRaw,
  rejectPreV7,
...
export const RestoreManifestSpec: ArtifactSpec<RestoreManifest> = {
  kind: KIND,
  ...
  parse(content, format) {
    ...
    return rejectPreV7<RestoreManifest>(raw, KIND, SUPPORTED);
  },

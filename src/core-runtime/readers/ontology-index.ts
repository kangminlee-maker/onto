...
export interface GlossaryEntry {
  ...
  code_entity?: string | undefined;
  db_table?: string | undefined;
  fk_variants: string[];
  value_filters?: ValueFilter[] | undefined;
}
...
export interface ActionEntry {
  ...
  source_code: string;
  guard_note?: string | undefined;
  // v3 확장 필드
  preconditions?: Precondition[] | undefined;
  results?: string[] | undefined;
  state_transitions?: string[] | undefined;  // transition ID 목록 (예: ["L1", "L2"])

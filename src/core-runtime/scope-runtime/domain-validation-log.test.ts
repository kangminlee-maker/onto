...
import {
  ...
  markValidation,
} from "./domain-validation-log.js";
import type { DomainAssumptionRecord } from "./domain-validation-log.js";

// ─── Test helpers ───

function makeRecord(overrides: Partial<DomainAssumptionRecord> = {}): DomainAssumptionRecord {
  return {
    assumption_id: "a-001",
...
describe("domain-validation-log", () => {
  describe("computeValidationMetrics", () => {
    ...
    it("단일 도메인의 stage1/stage2 분포를 산출한다", () => {
      const records: DomainAssumptionRecord[] = [
